...
pub struct HcomConfig {
    ...
    pub omp_args: String,
    /// Prime Agent specific launch arguments
    pub prime_args: String,
...
impl HcomConfig {
    ...
    pub fn get_field(&self, field: &str) -> Option<String> {
        match field {
            ...
            "prime_args" => Some(self.prime_args.clone()),
    ...
    pub fn set_field(&mut self, field: &str, value: &str) -> Result<(), String> {
        match field {
            ...
            "prime_args" => self.prime_args = value.to_string(),
